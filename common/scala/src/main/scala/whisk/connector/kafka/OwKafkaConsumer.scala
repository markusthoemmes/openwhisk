...
object OwKafkaConsumer {
   ...
   */
  def bufferedSource(servers: String, group: String, topic: String, maxBufferSize: Int)(
    implicit actorSystem: ActorSystem): Source[String, Any] = {

    batchedSouce(servers, group, topic, maxBufferSize).mapConcat(identity)
  }
   ...
   */
  def batchedSouce(servers: String, group: String, topic: String, maxBatchSize: Int)(
    implicit actorSystem: ActorSystem): Source[Queue[String], Any] = {
